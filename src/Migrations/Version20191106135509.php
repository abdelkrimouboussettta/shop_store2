 ...
 */
final class Version20191106135509 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaires CHANGE commentaires commentaire LONGTEXT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commentaires CHANGE commentaire commentaires LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
